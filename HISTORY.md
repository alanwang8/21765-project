...
- Added multi-audience docs (`docs/INSTALL.md`, `USER.md`, `DEVELOPER.md`), meta files (`LICENSE`, `CREDITS`, `SECURITY.md`), and `www/index.html`.
...
- Benchmarked memory and latency against PyTorch naive and SDPA paths (see project report notebook).
